MODULEs = ART300.MODULE ART301.MODULE ART302.MODULE COU300.MODULE COU301.MODULE CUS300.MODULE CUS301.MODULE DAT001.MODULE DAT002.MODULE FAM300.MODULE FAM301.MODULE LOG300.MODULE PAR200.MODULE PAR300.MODULE PRO200.MODULE PRO202.MODULE PRO300.MODULE XML001.RPGLE
PGMs = ART200.PGM ART201.PGM ART202.PGM CUS200.PGM LOG100.PGM ORD100.PGM ORD201.PGM PRO203.PGM

ART200.PGM:    $(d)/ART200-Work_with_article.PGM.SQLRPGLE
ART201.PGM:    $(d)/ART201-Work_with_article.PGM.RPGLE
ART202.PGM:    $(d)/ART202-Function_Article.PGM.RPGLE
CUS200.PGM:    $(d)/CUS200.PGM.SQLRPGLE
LOG100.PGM:    $(d)/LOG100.PGM.RPGLE
ORD100.PGM:    $(d)/ORD100.PGM.RPGLE
...
ORD500.PGM:    $(d)/ORD500.PGM.RPGLE
ORD900.PGM:    $(d)/ORD900.PGM.RPGLE
ORD901.PGM:    $(d)/ORD901.PGM.SQLRPGLE
PRO203.PGM:    $(d)/PRO203.PGM.SQLRPGLE
...
XML001.MODULE: $(d)/XML001.RPGLE XML.RPGLEINC txt.rpgleinc
